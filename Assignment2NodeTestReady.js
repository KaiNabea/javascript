//Flight Scheduling
/*
The following program follows a typical day at an airport, collecting the information for a passenger taking a flight from
Toronto to Vancouver. It uses objects to store important information about the flight the passenger will be taking, API's to 
retrieve data about the flights, async to time when a plane lands and when customers are directed to their gate and classes
to utilise methods regarding situations like boarding and final passenger calls. A basic HTML file is used for the front-end
of this Javascript file and a secondary Javascript file handles a second API call to prevent internal interference from two
API calls in the same page.
*/
...
//     fetch('https://api.aviationstack.com/v1/flights?access_key=4e685fb39ead7b0b804d5df8cf4ea968&flight_icao=ACA101&limit=1')
//         .then(response => {
...
//     const table1Body = document.getElementById('outputTable2').getElementsByTagName('tbody')[0]
...
//         const cellFlightCode1 = document.createElement('td')
//         cellFlightCode1.textContent = flights.flight.iata
//         const cellLeaving1 = document.createElement('td')
//         cellLeaving1.textContent = flights.departure.airport
//         const cellLeavingCode1 = document.createElement('td')
//         cellLeavingCode1.textContent = flights.departure.iata
//         const cellArriving1 = document.createElement('td')
//         cellArriving1.textContent = flights.arrival.airport
//         const cellArrivingCode1 = document.createElement('td')
//         cellArrivingCode1.textContent = flights.arrival.iata
//         const cellLeaveTime1 = document.createElement('td')
//         cellLeaveTime1.textContent = flights.departure.scheduled
//         const cellArriveTime1 = document.createElement('td')
//         cellArriveTime1.textContent = flights.arrival.scheduled
//         //appending to make sure the data and row are added to the table and doesn't replace what's already there
//         row1.appendChild(cellFlightCode1)
//         row1.appendChild(cellLeaving1)
//         row1.appendChild(cellLeavingCode1)
//         row1.appendChild(cellArriving1)
//         row1.appendChild(cellArrivingCode1)
//         row1.appendChild(cellLeaveTime1)
//         row1.appendChild(cellArriveTime1)
    ...
    let promise = new Promise((resolve, reject) => {
        if (captain > 0) {
            resolve("Good morning passengers, this is your Captain speaking. The time is " + flight.departureTime +
                " and we are preparing for take off. The in-flight presentation will be commencing shortly. In the " +
                "meantime, please remain in your seats, fasten your seatbelts and we hope you have a wonderful flight.")
        }
    })
    promise.then(speaker => {
        console.log(speaker)
